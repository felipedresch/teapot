...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-espresso/15 backdrop-blur-sm',
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          'bg-cream shadow-dreamy-lg border-border/30',
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn('text-foreground font-display text-lg', className)}
      {...props}
    />
  )
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn('text-warm-gray text-sm', className)}
      {...props}
    />
  )
}
